    ...
    extends Service
{
    ...
    private final static QName RABBITCOUNTERSERVICE_QNAME = new QName("http://rabbit.ws.study.falbuquerque/", "RabbitCounterService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://127.0.0.1:9877/rabbit?wsdl");
    ...
    public RabbitCounter getRabbitCounterPort() {
        return super.getPort(new QName("http://rabbit.ws.study.falbuquerque/", "RabbitCounterPort"), RabbitCounter.class);
    }
    ...
    public RabbitCounter getRabbitCounterPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://rabbit.ws.study.falbuquerque/", "RabbitCounterPort"), RabbitCounter.class, features);
    }
