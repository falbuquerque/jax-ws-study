 ...
 * generated in the falbuquerque.study.ws.timer.client.generated package. 
...
public class ObjectFactory {
    ...
    private final static QName _TimeElapsed_QNAME = new QName("http://timer.ws.study.falbuquerque/", "time_elapsed");
    private final static QName _TimeElapsedResponse_QNAME = new QName("http://timer.ws.study.falbuquerque/", "time_elapsedResponse");
    private final static QName _AcceptInput_QNAME = new QName("http://timer.ws.study.falbuquerque/", "acceptInput");
    private final static QName _TimeString_QNAME = new QName("http://timer.ws.study.falbuquerque/", "time_string");
    private final static QName _TimeStringResponse_QNAME = new QName("http://timer.ws.study.falbuquerque/", "time_stringResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: falbuquerque.study.ws.timer.client.generated
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://timer.ws.study.falbuquerque/", name = "time_elapsed")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://timer.ws.study.falbuquerque/", name = "time_elapsedResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://timer.ws.study.falbuquerque/", name = "acceptInput")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://timer.ws.study.falbuquerque/", name = "time_string")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://timer.ws.study.falbuquerque/", name = "time_stringResponse")
